...
const project = {
  ...
  "summary": "Transformer Core is a curated project from the Justin21523 GitHub portfolio. Pure PyTorch implementation of Self-Attention & TransformerBlock",
  "category": "ai-data",
  "year": 2026,
  "status": "prototype",
  "technologies": [],
  "githubUrl": "https://github.com/Justin21523/transformer-core",
  "readmeUrl": "https://github.com/Justin21523/transformer-core#readme",
  ...
  "records": [
    {
      "id": "flow-01",
      "name": "Detected technical signals: the detected source files,README evidence exists and can support a fuller reviewed case study,A public GitHub repository is linked for source traceability",
      "status": "Ready",
      "owner": "Frontend"
    },
    {
    ...
    {
      "id": "flow-03",
      "name": "Detected stack: source files pending review",
      "status": "Queued",
      "owner": "Automation"
    }
  ]
